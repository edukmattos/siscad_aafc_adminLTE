...
<div class="form-group {{ $errors->has('birthday') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
		<div class="input-group date">
			...
			{!! Form::text('birthday', isset($employee->birthday) ? $employee->birthday->format('d/m/Y') : null, ['id'=>'birthday_datepicker', 'class'=>'form-control']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('date_start') ? 'has-error' : '' }}">
	<label for="date_start" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Entrada:</label>
	<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
		<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			{!! Form::text('date_start', isset($employee->date_start) ? $employee->date_start->format('d/m/Y') : null, ['id'=>'date_start_datepicker', 'class'=>'form-control']) !!}
		</div>
	</div>
</div>
...
@section('js_scripts')
	<script type="text/javascript">
	  	$("#management_units_list, #company_sectors_list, #company_sub_sectors_list, #company_positions_list, #company_responsibilities_list, #employee_startes_list, #employee_start_reasons_list, #genders_list, #cities_list").select2();
	  	$("#birthday_datepicker, #date_start_datepicker").datepicker(
	  		{
