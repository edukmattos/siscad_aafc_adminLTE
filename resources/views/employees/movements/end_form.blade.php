<div class="form-group {{ $errors->has('company_position_id') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
		<div class="input-group input-group-sm">
			...
			{!! Form::select('company_position_id', $company_positions, $value = null, ['id'=>'company_positions_list', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('company_responsibility_id') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('company_responsibility_id', $company_responsibilities, $value = null, ['id'=>'company_responsibilities_list', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('management_unit_id') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('management_unit_id', $management_units, $value = null, ['id'=>'management_units_list', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('company_sector_id') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('company_sector_id', $company_sectors, $value = null, ['id'=>'company_sectors_list', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('company_sub_sector_id') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('company_sub_sector_id', $company_sub_sectors, $value = null, ['id'=>'company_sub_sectors_list', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('date_start') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-3 col-lg-3">
		<div class="input-group">
			...
			{!! Form::text('date_start', isset($employee_movement->date_start) ? $employee_movement->date_start->format('d/m/Y') : null, ['id'=>'date_start_datepicker', 'class'=>'form-control', 'disabled'=>'true']) !!}
		</div>
	</div>
</div>
