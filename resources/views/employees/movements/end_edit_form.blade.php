...
<div class="form-group {{ $errors->has('date_end') ? 'has-error' : '' }}">
	<label for="date_end" class="col-sm-2 control-label">Saída:</label>
	<div class="col-sm-8">
		<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			{!! Form::text('date_end', isset($employee_movement->date_end) ? $employee_movement->date_end->format('d/m/Y') : null, ['id'=>'date_end_datepicker', 'class'=>'form-control datepicker date_mask']) !!}
		</div>
	</div>
</div>
