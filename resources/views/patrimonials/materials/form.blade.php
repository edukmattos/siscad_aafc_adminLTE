...
<div class="form-group {{ $errors->has('intervention_date') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
		<div class="input-group input-group-sm date">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			{!! Form::text('intervention_date', isset($patrimonial_material->intervention_date) ? $patrimonial_material->intervention_date->format('d/m/Y') : null, ['id'=>'intervention_date_datepicker', 'class'=>'form-control']) !!}
...
<div class="form-group {{ $errors->has('material_id') ? 'has-error' : '' }}">
	<label for="material_id" class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">Material:</label>
	<div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
		<div class="input-group input-group-sm">
			<span class="input-group-addon"><i class="fa fa-question-circle"></i></span>
			{!! Form::select('material_id', $materials, $value = null, ['id'=>'materials_list', 'class'=>'form-control']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('invoice_date') ? 'has-error' : '' }}">
	...
	<div class="col-xs-12 col-sm-4 col-md-2 col-lg-2">
		<div class="input-group input-group-sm date">
			<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
			{!! Form::text('invoice_date', isset($patrimonial_material->invoice_date) ? $patrimonial_material->invoice_date->format('d/m/Y') : null, ['id'=>'invoice_date_datepicker', 'class'=>'form-control']) !!}
		</div>
	</div>
</div>
...
@section('js_scripts')
	<script type="text/javascript">
	  	$("#materials_list, #providers_list, #patrimonial_intervention_types_list").select2();
