<div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
	...
	<div class="col-sm-9">
		<div class="input-group date">
			...
			{!! Form::text('date', isset($meeting->date) ? $meeting->date->format('d/m/Y') : null, ['id'=>'date_datepicker', 'class'=>'form-control datepicker date_mask']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('participants_estimated_qty') ? 'has-error' : '' }}">
	...
	<div class="col-sm-9">
		<div class="input-group">
			...
			{!! Form::text('participants_estimated_qty', $value = null, ['id'=>'participants_estimated_qty', 'class'=>'form-control numeric_0_mask']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('participants_confirmed_qty') ? 'has-error' : '' }}">
	...
	<div class="col-sm-9">
		<div class="input-group">
			<span class="input-group-addon"><i class="fa fa-users"></i></span>
			{!! Form::text('participants_confirmed_qty', $value = null, ['id'=>'participants_confirmed_qty', 'class'=>'form-control numeric_0_mask']) !!}
		</div>
	</div>
</div>
...
<div class="form-group {{ $errors->has('participants_refunds_amount') ? 'has-error' : '' }}">
	...
	<div class="col-sm-9">
		<div class="input-group">
			...
			{!! Form::text('participants_refunds_amount', $value = null, ['id'=>'participants_refunds_amount', 'class'=>'form-control numeric_2_mask']) !!}
		</div>
	</div>
</div>
