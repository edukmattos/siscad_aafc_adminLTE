...
class PatrimonialSectorRequest extends Request
{
    /**
    ...
    {
        return [
            'code' => 'max:5|required|unique:patrimonial_sectors,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:patrimonial_sectors,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
