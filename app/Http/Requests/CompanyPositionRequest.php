...
class CompanyPositionRequest extends Request
{
    /**
    ...
    {
        return [
            'code' => 'max:3|required|unique:company_positions,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:company_positions,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
