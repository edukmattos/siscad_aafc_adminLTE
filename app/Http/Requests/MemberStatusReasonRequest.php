...
class MemberStatusReasonRequest extends Request
{
    /**
    ...
    {
        return [
            'code' => 'max:2|required|unique:member_status_reasons,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:member_status_reasons,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
