...
class PartnerSectorRequest extends Request
{
    /**
    ...
    {
        return [
            'code' => 'max:5|required|unique:partner_sectors,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:30|required|unique:partner_sectors,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
