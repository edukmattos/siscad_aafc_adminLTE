...
class PatrimonialSubTypeRequest extends Request
{
    ...
    {
        return [
            'code' => 'max:5|required|unique:patrimonial_sub_types,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:patrimonial_sub_types,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
