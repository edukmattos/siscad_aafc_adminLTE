...
class PatrimonialBrandRequest extends Request
{
    ...
    {
        return [
            'code' => 'max:5|required|unique:patrimonial_brands,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:patrimonial_brands,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
