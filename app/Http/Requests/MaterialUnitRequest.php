...
class MaterialUnitRequest extends Request
{
    ...
    {
        return [
            'code' => 'max:5|required|unique:material_units,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:material_units,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
