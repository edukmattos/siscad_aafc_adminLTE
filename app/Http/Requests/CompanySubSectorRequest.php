...
class CompanySubSectorRequest extends Request
{
    /**
    ...
    {
        return [
            'code' => 'max:5|required|unique:company_sub_sectors,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:company_sub_sectors,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
