...
class PaymentStatusRequest extends Request
{
    ...
    {
        return [
            'code' => 'max:3|required|unique:payment_statuses,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:payment_statuses,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
