...
class PaymentMethodRequest extends Request
{
    ...
    {
        return [
            'code' => 'max:3|required|unique:payment_methods,code,'.$this->id.',id,deleted_at,NULL',
            'description' => 'max:20|required|unique:payment_methods,description,'.$this->id.',id,deleted_at,NULL'
            //
        ];
    }
